...
public class CrearBarrioUseCaseImpl implements CrearBarrioUseCase {
    ...
    public CrearBarrioUseCaseImpl(BarrioRepositoryPort barrioRepository, CuadranteRepositoryPort cuadranteRepository, BarrioDomainMapper mapper) {
    ...
    public BarrioDTO execute(CrearBarrioCommand command) {
        ...
        Barrio barrio = Barrio.crear(command.nombre(), command.cuadranteId());
